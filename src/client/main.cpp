...
void readTaskHandler(int clientfd)
{
    for (;;)
    {
        ...
        {
            cout << js["time"] << "[" << js["groupid"] << "]" << "群消息:" << "[" << js["id"] << "]" << js["name"] << " said: " << js["msg"] << endl;
            continue;
        }
    ...
    else
    {
        ...
        if (responsejs.contains("offlinemsg"))
        {
            ...
            for (string &str : vec)
            {
                ...
                // cout << js["time"] << "[" << js["id"] << "]" << js["name"] << " said: " << js["msg"] << endl;
                // cout << "[" << js["id"] << "]" << js["name"] << " said: " << js["msg"] << endl;
                ...
                {
                    cout << "[" << js["groupid"] << "]" << "群消息:" << js["time"] << "[" << js["id"] << "]" << js["name"] << " said: " << js["msg"] << endl;
                }
            }
        }
    }
